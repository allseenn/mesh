...
Моя домашняя локальной сеть, в основном, построена на витой паре, из соображений безопасности, помехоустойчивости, меньшей латентности и большей скорости. К этой сети подключены ПК, ноутбуки, телевизоры, принтеры, приставки, ip-телефоны и т.д.
